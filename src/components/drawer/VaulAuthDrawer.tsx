...
import './VaulAuthDrawer.css';

interface VaulAuthDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
export const VaulAuthDrawer: React.FC<VaulAuthDrawerProps> = ({
  isOpen,
  onClose,
  onSignIn,
  onSignUp,
  ...
  const handleModeChange = (newMode: AuthMode) => {
    // Blur any focused input to prevent keyboard issues
  ...
  return (
    ...
    >
      <Drawer.Portal>
        <Drawer.Overlay className="fixed inset-0 bg-black/40" style={{ backdropFilter: 'blur(12px)' }} />
        <Drawer.Content 
          className="vaul-auth-drawer"
          style={{
            maxHeight: mode === 'signin' ? '55vh' : '75vh',
            height: mode === 'signin' ? '55vh' : '75vh',
            transition: 'all 0.4s cubic-bezier(0.32, 0.72, 0, 1)',
          }}
        >
          <div className="vaul-auth-drawer__inner">
            {/* Accessible Title */}
            ...
            {/* Form Content */}
            <div className="vaul-auth-drawer__content">
              <form onSubmit={handleSubmit} className="auth-drawer__form">
                ...
                {mode === 'signup' && (
                  <div className="auth-drawer__field">
                    <label htmlFor="vaul-name" className="auth-drawer__label">
                      <User size={16} />
                      <span>Full Name</span>
                    </label>
                    <input
                ...
                {/* Email Field */}
                <div className="auth-drawer__field">
                  <label htmlFor="vaul-email" className="auth-drawer__label">
                    <Mail size={16} />
                    <span>Email</span>
                  </label>
                  <input
                ...
                {/* Password Field */}
                <div className="auth-drawer__field">
                  <label htmlFor="vaul-password" className="auth-drawer__label">
                    <Lock size={16} />
                    <span>Password</span>
                  </label>
                ...
                {mode === 'signup' && (
                  <div className="auth-drawer__field">
                    <label htmlFor="vaul-confirmPassword" className="auth-drawer__label">
                      <Lock size={16} />
                      <span>Confirm Password</span>
                    </label>
                    <div className="auth-drawer__input-wrapper">
                      <input
                        id="vaul-confirmPassword"
